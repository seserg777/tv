 ...
 * @subpackage  Models
 */
class TvshowsModelFilm extends JModelAdmin
{
	/**
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_tvshows.film';
	 ...
	 */
	public function getTable($type = 'Film', $prefix = 'TvshowsTable', $config = array())
	{
	...
	{
		$pk = (!empty($pk)) ? $pk : (int) $this->getState('film.id');
		...
		if (!isset($this->_item[$pk]))
		{
			...
			try
			{
				...
				$seasons = $db->loadObjectList();
			  	...
			  	//$this->_item[$pk]->tags->getTagIds($pk, 'com_tvshows.film');
