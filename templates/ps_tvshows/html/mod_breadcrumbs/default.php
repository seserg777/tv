...
<?php if($task == 'view' && $option == 'com_jshopping' && $controller == 'product' && $session->get('jshop_end_page_list_product')){?>
    <a class="pull-right" href="<?php echo $session->get('jshop_end_page_list_product');?>">вернуться назад</a>
<?php } ?>