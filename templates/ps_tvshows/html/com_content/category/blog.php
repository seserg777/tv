...
if(trim($pageclass) == 'portfolio'){?>
	<script>
		/*jQuery(document).ready(function(){
			jQuery('#content .blog.portfolio .items-row > [class*="span"] .item .readmore a').on('click',function(e){
				e.preventDefault();
...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
	...
	<?php if($view == 'category' && $layout == 'blog' && $option == 'com_content'){
		$document = JFactory::getDocument();
		$renderer   = $document->loadRenderer('modules');
		$options    = array('style' => 'xhtml');
		$position   = 'blog-after-title';
