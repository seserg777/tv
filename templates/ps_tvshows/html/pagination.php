...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled tech"><a>'.JText::_('JLIB_HTML_START').'</a></li>';
	}

	// Check for "Prev" item
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled tech"><a>'.JText::_('JPREV').'</a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled tech"><a>'.JText::_('JNEXT').'</a></li>';
	}

	// Check for "End" item
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		return '<li class="disabled tech"><a>'.JText::_('JLIB_HTML_END').'</a></li>';
	}
