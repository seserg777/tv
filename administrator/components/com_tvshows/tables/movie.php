 ...
 * @subpackage  Tables
 */
class TvshowsTableMovie extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__tvshows_movies', 'id', $db);
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_tvshows.movie'));
	}
