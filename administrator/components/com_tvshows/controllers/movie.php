 ...
 */
class TvshowsControllerMovie extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Movie', 'TvshowsModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_tvshows&view=movies' . $this->getRedirectToListAppend(), false));
